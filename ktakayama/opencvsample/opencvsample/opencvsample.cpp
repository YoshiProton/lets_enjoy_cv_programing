...
int main()
{
	...
	cv::imwrite("lena_gray_cv.jpg", gray_cv); // 課題1-2 
	cv::imwrite("lena_gray_own.jpg", gray_own); // 課題1-3 
	cv::imwrite("lena_scale_cv.jpg", scale_cv); // 課題1-4 
	cv::imwrite("lena_scale_own.jpg", scale_own); // 課題1-5 
	...
	cv::imwrite("hsv100.jpg", image_hsv); // 課題2-3
	cv::imwrite("lena_skinDetect_own.jpg", skin_own); // 課題2-4 
